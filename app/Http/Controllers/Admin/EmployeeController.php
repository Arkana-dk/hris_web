...
class EmployeeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Return Inertia React component
    ...
    public function show(Employee $employee)
    {
        ...
        return \Inertia\Inertia::render('Admin/Employees/Show', [
            'employee' => $employee->load(['department', 'section', 'position', 'group', 'payGroup', 'user']),
        ]);
    }
